...
public class TestBanking
{
  ...
  public static void main(String[] args)
  {
    ...
    Cuenta  account;       // lo usa para leer todas las cuentas

    // Create two customers and their accounts
    Banco.addCustomer("Jane", "Simms");          //agrega un cte
    customer = Banco.getCustomer(0);             //lo lee y almacena en customer
    customer.addAccount(new CajaDeAhorro(500.00, 0.05));
    //le agrega cuentas
    customer.addAccount(new CuentaCorriente(200.00, 500.00));
    //agrega un nuevo cliente
    Banco.addCustomer("Owen", "Bryant");
    //lo lee
    customer = Banco.getCustomer(1);
    //le agrega una cuenta
    customer.addAccount(new CajaDeAhorro(200.00, 0.03));
